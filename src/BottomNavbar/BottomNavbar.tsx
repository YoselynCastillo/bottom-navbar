...
const BottomNavbar = ({onActiveChange}: any) => {
  ...
  useEffect(() => {
    onActiveChange(active === '' ? false : true); // Llama a la función de devolución de llamada cuando active cambia
    ...
    <div className="contend">
      <div className="container">
        ...
        <div ref={bottomContentRef} className="bottom_content">
          <div
            className={`nav-item  ${active === "sell" && "active"}`}
